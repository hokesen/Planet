...
export default function WormholeModal({
    ...
    const dailyRockets = activeRockets.filter(
        (r) => r.mission.commitment_type === 'daily',
    );
    const weeklyRockets = activeRockets.filter(
        (r) => r.mission.commitment_type === 'weekly',
    );
    const monthlyRockets = activeRockets.filter(
        (r) => r.mission.commitment_type === 'monthly',
    );
                ...
                <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="h-2 w-full overflow-hidden rounded-full bg-gray-700">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.min(100, capacity.percentages.daily_percentage)}%`,
                                        }}
                                    />
                                </div>
                                ...
                                <div className="text-xs text-gray-500">
                                    {capacity.commitment.daily_rockets} rocket
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="h-2 w-full overflow-hidden rounded-full bg-gray-700">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.min(100, capacity.percentages.weekly_percentage)}%`,
                                        }}
                                    />
                                </div>
                                <div className="text-xs text-gray-400">
                                ...
                                <div className="text-xs text-gray-500">
                                    {capacity.commitment.weekly_rockets} rocket
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="h-2 w-full overflow-hidden rounded-full bg-gray-700">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.min(100, capacity.percentages.monthly_percentage)}%`,
                                        }}
                                    />
                                </div>
                                <div className="text-xs text-gray-400">
                                ...
                                <div className="text-xs text-gray-500">
                                    {capacity.commitment.monthly_rockets} rocket
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg font-semibold">
                            Active Rockets ({activeRockets.length})
                        </h3>
                                        ...
                                        <div className="space-y-2">
                                            {dailyRockets.map((rocket, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        className={`rounded border px-2 py-1 text-xs font-medium ${getPriorityBadgeColor(rocket.mission.priority)}`}
                                                    >
                                                        {
                                                            rocket.mission
                                                                .priority
